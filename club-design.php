...
<body>
  ...
  <p>
    I created this donut model as my first project using blender last year in Medium Design Collective.
  </p>
  ...
  <p>
    I created this console model as my second project using blender last year in Medium Design Collective.
  </p>

  <div class = "name">
    <p>3. Raw Exhibition Poster</p>
  </div>
  <figure>
    <!-- Source: (original artwork) Mary Zhang -->
  ...
  <p>
    I created this poster as my final project using blender last year in Medium Design Collective.
  </p>

  <div class = "name">
    <p>4. Breakfree Audition Poster</p>
  </div>
  <figure>
    <!-- Source: (original artwork) Mary Zhang -->
  ...
  <p>
    I created this poster for the dance team I am in.
  </p>

  <div class = "name">
    <p>4. Breakfree Dancefest and Clubfest Poster</p>
  </div>
  <figure>
    <!-- Source: (original artwork) Mary Zhang -->
